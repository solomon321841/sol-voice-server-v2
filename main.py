...
async def websocket_handler(ws: WebSocket):
    ...
    try:
        ...
        tts_greet = await openai_client.audio.speech.create(model="gpt-4o-mini-tts", voice="ash", input=greet_input)
    ...
    async def _tts_and_send(tts_text: str, t_turn: int):
        ...
        try:
            ...
            tts = await openai_client.audio.speech.create(model="gpt-4o-mini-tts", voice="ash", input=tts_payload)
